...
- name: Google Surveys API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-consumer-surveys/master/_listings/google-consumer-surveys/surveys-surveyurlid-results-get.md
x-common:
- type: x-developer
